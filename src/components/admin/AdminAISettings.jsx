...
const GEMINI_MODELS = [
  { id: 'gemini-2.5-flash', label: 'gemini-2.5-flash (Recommended / Free Tier)', desc: 'Fast, balanced multimodal performance' },
  ...
  { id: 'gemini-3.5-flash-lite', label: 'gemini-3.5-flash-lite', desc: 'Ultra-fast low-latency model' },
];
